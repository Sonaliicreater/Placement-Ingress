...
public class EditDeleteStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/training_placement_mgmt/sign-up - Copy.png"))); // NOI18N
        jLabel9.setText(" ");
        ...
        jLabel10.setText("Edit / Delete Student");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/placementss","root","");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            ...
            String q,sid,n,po,ap,em,c,str;
            sid=txtsid.getText();
            n=txtstname.getText();
            po=txtstpointer.getText();
            ap=txtapp1.getText();
            str=cmbStream.getText().toString();
            em=txtstemail.getText();
            c=txtstcon.getText();
            q="update student set Student_Name = '"+n+"',Aggregate_Pointer='"+po+"',Aptitude_Test_Scores='"+ap+"',Stream='"+str+"',Contact_Number="+c+",Email_Id='"+em+"'";
            st.executeUpdate(q);
